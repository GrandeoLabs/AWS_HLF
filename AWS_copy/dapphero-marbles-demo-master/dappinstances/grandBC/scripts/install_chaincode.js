...
// --- Set Details Here --- //
var config_file = 'connection_profile_aws.json';							//set config file name
var chaincode_id = 'grandBC';									//set desired chaincode id to identify this chaincode
...
fcw.enrollWithAdminCert(cp.makeEnrollmentOptionsUsingCert(), function (enrollErr, enrollResp) {
	if (enrollErr != null) {
		...
		var opts = {
			...
			path_2_chaincode: 'grandBC',				//path to chaincode from <marbles root>/chaincode/src/
